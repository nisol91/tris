...
$(document).ready(function() {
  ...
  $('.element').click(function() {
    ...
    if (posiz.includes(posizElem)) {
    ...
    } else if ($(this).find('h1').text() == 'o') {
      alert('non puoi cliccare 2 volte')
    }
    else {
      questoElemento.find('h1').text('x');
      ...
      $('.griglia .element').each(function(index) {
        if ($(this).find('h1').text() != 'x' && $(this).find('h1').text() != 'o') {
          numero = index
          numeri.push(numero)
          console.log(numeri);
        } else if ($(this).find('h1').text() === 'x') {
          numero_x = index
      ...
      $('.griglia .element').each(function(index) {
        if ($(this).index() == position_0 && $(this).find('h1').text() != 'x' && $(this).find('h1').text() != 'o') {
          $(this).find('h1').text('o');
        }
      });
    }
